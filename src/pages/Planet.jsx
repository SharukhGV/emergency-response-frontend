...
import MoonTonight from "./MoonTonight.png"
...
function Planet({ planet }) {
  ...
  return (
    ...
    <div>
      ...
      <>{(planet.name === "Moon" && planet.aboveHorizon === true) ?
          ...
          <div style={{ fontFamily: "Arial" }} className="card">
            ...
            <div className="card__overlay">
              <div className="card__header">
                ...
                <img className="card__thumb" src={MoonTonight} alt="" />
      ...
      <div></div>
      <div></div><div>{planet.name === "Mercury" ?
