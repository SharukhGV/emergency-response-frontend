...
<br></br>
<br></br>
  <img style={{width:"150px",height:"auto"}} src={astronaut}></img>
  {/* </Link> */}
...
<h5 style={{margin:"50px",backgroundColor:"rgba(0,0,0,0.5)", borderRadius:"5px",padding:"10px"}}>A Bee Hive is full of... well... bees! The night sky is full of stars.
This app is meant to be a culmination of useful information for the
average city-dweller to find and get to a place of starry beauty.</h5>
<h5 style={{margin:"50px",backgroundColor:"rgba(0,0,0,0.5)", borderRadius:"5px"}}>Almost 80% of the world's populations cannot see the Milky Way band, and
such beauty being hidden is truly a catastrophe!</h5></div>
