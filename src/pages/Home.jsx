...
import MeteorShowers from "../components/GeoAstroEvents/MeteorShowers";

import dreamssection from "./dreamssection.png"
import communityposts from "./communityposts.png"
  ...
  function renderModalButtons() {
    return (
      <div className="buttonPollCont">
        <button className="button earthTremors" onClick={modal1Click}>Earth Tremors</button>
        <button className="button migratoryPatterns" onClick={modal2Click}>Migratory Pattern Shifts</button>
        <button className="button invasiveSpecies" onClick={modal3Click}>Invasive Species Sightings</button>
        <button className="button unusualWeather" onClick={modal4Click}>Unusual Weather</button>
        <button className="button wildlifeAnomalies" onClick={modal5Click}>Wildlife Anomalies</button>
        <button className="button waterLevelChanges" onClick={modal6Click}>Water Level Changes</button>
        <button className="button otherCategory" onClick={emergencySETTER}>Anything Else</button>
      </div>
    );
  }
  ...
  return (
    ...
    <div className="containermainpage">
      ...
      <div className="main" >
         ...
         */}
          <div className="smallerHomeAnomaly">
