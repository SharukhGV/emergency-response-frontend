...
<div style={{backgroundColor:"black", color:"white"}} className="skydescription">・:*˚:✧｡・:*˚:✧｡・:*˚:✧｡</div>
<div  style={{backgroundColor:"black", color:"white"}}  className="skydescription">Sky Description: In areas with minimal light pollution, the sky appears exceptionally dark. The Milky Way is vividly visible, and thousands of stars are discernible.
...
<div style={{backgroundColor:"black", color:"white"}} className="skydescription">Sky Description: Light pollution begins to affect the visibility of fainter stars, causing a visible glow near the horizon. However, major constellations and the Milky Way's core are still relatively clear.
Approximate Star Visibility: Roughly 1,000 to 2,000 stars visible to the naked eye.</div>
<strong><div className="skydescription" style={{backgroundColor:"rgba(58, 55, 50, 100)", color:"white"}} >30-50% Light Pollution:</div></strong>
<div className="skydescription" style={{backgroundColor:"rgba(58, 55, 50, 100)", color:"white"}} >｡ ✧ ｡ ✧｡</div>

<div style={{backgroundColor:"rgba(58, 55, 50, 100)", color:"white"}} className="skydescription">Sky Description: Moderate light pollution dims the view of the Milky Way and fainter stars. Only the brightest stars and major constellations are easily identifiable.
...
<div style={{backgroundColor:"rgb(85, 72, 43)", color:"white"}} className="skydescription">✧</div>

<div  style={{backgroundColor:"rgb(85, 72, 43)", color:"white"}} className="skydescription">Sky Description: Substantial light pollution obscures most of the Milky Way and dimmer stars, leaving only the brightest stars and planets visible. The sky appears significantly brightened, even at night.
