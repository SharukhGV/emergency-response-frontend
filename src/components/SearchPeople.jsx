...
<div>
<button style={{borderRadius:"10px",border: "2px solid #373436", width:"70px", height:"70px", opacity:"0.8", backgroundColor:"black", fontSize:"10px"}} onClick={allPostsSet}>Every Single Post</button>
<span>     </span>
<button className="northernLights" style={{borderRadius:"10px", width:"70px", height:"70px",  opacity:"0.8",backgroundColor:"black", fontSize:"10px"}} onClick={northernLights}>Northern Lights</button>
<span>     </span>

<button className="fireBall" style={{borderRadius:"10px", width:"70px", height:"70px",  opacity:"0.8", backgroundColor:"black", fontSize:"10px"}} onClick={meteoricEvent}>Meteoric Events</button>
<span>     </span>

<button style={{borderRadius:"10px",border: "2px solid #373436", opacity:"0.8", width:"70px", height:"70px", backgroundColor:"black", fontSize:"10px"}} onClick={lowLightPollution}>Low Light Pollution</button>
</div>
