...
export default function SearchPeople({ loginUsername, setMapMarkers, emergencyType, setLongitude, setLatitude, lat, lng }) {
  ...
  return (
    <div>
      ...
      <br></br>
      <div>
        <button style={{ textShadow: "0 0 3px #000000, 0 0 5px #ffffff", borderRadius: "10px", border: "2px solid #373436", width: "100px", height: "70px", opacity: "0.8", backgroundColor: "black", fontSize: "10px" }} onClick={allPostsSet}>All Posts<div style={{ fontSize: "17px" }}></div></button>
        <span>     </span>
        <button className="northernLights" style={{ border: "2px solid #373436", textShadow: "0 0 3px #000000, 0 0 5px #ffffff", borderRadius: "10px", width: "100px", height: "70px", opacity: "0.8", backgroundColor: "black", fontSize: "10px" }} onClick={northernLights}>Auroras <div style={{ fontSize: "17px" }}>🌃</div></button>
        <span>     </span>

        <button className="fireBall" style={{ border: "2px solid #373436", textShadow: "0 0 3px #000000, 0 0 5px #ffffff", borderRadius: "10px", width: "100px", height: "70px", opacity: "0.8", backgroundColor: "black", fontSize: "10px" }} onClick={meteoricEvent}>Meteors <div style={{ fontSize: "17px" }}>☄️</div></button>
        <span>     </span>

        <button style={{ textShadow: "0 0 3px #000000, 0 0 5px #ffffff", borderRadius: "10px", border: "2px solid #373436", opacity: "0.8", width: "100px", height: "70px", backgroundColor: "black", fontSize: "10px" }} onClick={lowLightPollution}>Low LP <div style={{ fontSize: "17px" }}>🌆</div></button>
      </div>
<br></br>
